...
- `VITE_SUPABASE_URL` と `VITE_SUPABASE_ANON_KEY` はshared modeの接続設定です。ブラウザへservice role keyを入れてはいけません。初期4 migrationのLivingtown projectへのapply観測は [`SUPABASE_REAL_DB_GATE_2026-08-30.md`](./docs/evidence/SUPABASE_REAL_DB_GATE_2026-08-30.md) に記録していますが、function EXECUTE hardening、pgTAP、Security Advisor再確認、Browser A/B検証は別途必要です。
